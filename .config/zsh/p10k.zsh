# Powerlevel10k is loaded via antidote (see .zsh_plugins.txt)
# This file only contains the p10k configuration

# Generated by Powerlevel10k configuration wizard on 2024-08-23 at 15:40 CEST.
...
# 2 lines, solid, left frame, darkest-ornaments, compact, many icons, fluent,
